...
class Triangle extends Shape {
    ...
    render() {
        ...
        <polygon points="50,200 250,200 150,50" fill="${this.fillColor}" />
...
class Circle extends Shape {
    ...
    render() {
      ...
      <text x="150" y="125" text-anchor="middle" fill="${this.textColor}" font-size="60">${this.text}</text>
...
class Square extends Shape {
    ...
    render() {
      ...
      <rect x="50" y="25" width="200" height="200" fill="${this.fillColor}" />

      <text x="150" y="150" text-anchor="middle" fill="${this.textColor}" font-size="80">${this.text}</text>
